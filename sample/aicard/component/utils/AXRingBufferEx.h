...
public:
    AX_U32 nTotalSize;  // internal used, must aligned to sizeof(CAXRingBufferEx)
    AX_U32 nSize;
    AX_U64 nPts;
    AX_BOOL bIFrame;
    AX_U32 nHeadSize;
...
public:
    CAXRingBufferEx(AX_U32 nElementBuffSize, AX_U32 nElementCount, const char* pszName = nullptr) {
        ...
        m_nRingSize = RING_ALIGN_TO(m_nRingSize, sizeof(CAXRingElementEx)); // make sure not rollback
