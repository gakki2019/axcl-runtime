...
static void ax_pcie_msg_attr_init(struct ax_pcie_msg_attr *attr)
{
	int i;
...
static ax_pcie_msg_handle_t *ax_pcie_msg_open(struct ax_pcie_msg_attr *attr)
{
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Axera");
MODULE_DESCRIPTION("AXERA PCIE MSG DRIVER");
