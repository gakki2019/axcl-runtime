...
ax_install()
{
    ...
    # cp sample && axcl.json
    cp -rf ${installpath}/axcl/out/axcl_linux_x86/bin/axcl* ${axcl_bin_path}/
    ...
    cp -rf ${installpath}/axcl/out/axcl_linux_x86/bin/ffmpeg ${axcl_bin_path}/
    chmod 777 $(axcl_bin_path)/ffmpeg/*
